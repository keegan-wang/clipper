...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QTextEdit, QFileDialog,
    QListWidget, QTabWidget, QLineEdit, QListWidgetItem, QProgressBar, QStackedWidget, QGridLayout
)
...
class VideoApp(QWidget):
    ...
    def startProcessing(self):
        ...
        if not script_text:
            print("Please provide a script.")
            return

        self.progressBar.setValue(10)

        # Start processing in a separate thread
        self.processorThread = VideoProcessorThread(script_text)
